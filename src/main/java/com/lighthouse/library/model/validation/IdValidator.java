package com.lighthouse.library.model.validation;
  ...
  private <T> Map<String, T> listByIds(
    ...
    try {
      ...
      if (idGetter != null) {
        ...
        com.lighthouse.library.model.security.UserSecurityContext securityContextPrincipal =
            (com.lighthouse.library.model.security.UserSecurityContext)
